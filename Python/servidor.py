...
def create_match(current_user):
    try:
        ...
        # Debug: Verificar existencia del mazo
        deck = dao_decks.getDeckByID(deck_id)
        if not deck:
            return jsonify({
        ...
        # Debug: Verificar propiedad del mazo
        ...
        # Debug: Verificar cartas en el mazo
        ...
        return jsonify({
            ...
            "debug_info": {
                ...
                "first_5_cards": [c['id'] for c in cards[:5]]
            }
        }), 201
...
@token_required
def debug_match_info(current_user):
    ...
    try:
        return jsonify({
            ...
            "all_matches": dao_matches.getPlayerMatches(current_user['id'])
        }), 200
    except Exception as e:
